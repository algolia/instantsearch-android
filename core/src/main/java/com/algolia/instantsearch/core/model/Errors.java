...
public class Errors {
    ...
    public static final String BINDING_VIEW_NO_ID = "Your View (%s) for attribute '%s' must have an android:id.";
    public static final String BINDING_VIEW_NO_ID_NOR_ATTR = "Your View (%s) must have an android:id.";
