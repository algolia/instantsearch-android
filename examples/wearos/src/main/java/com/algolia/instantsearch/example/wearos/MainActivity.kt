...
class MainActivity : ComponentActivity() {
    ...
    private val startSpeech = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
    ...
    private fun navigateToSearch(query: String) {
        ...
        intent.putExtra(MoviesActivity.ExtraQuery, query)
