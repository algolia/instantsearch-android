...
import com.algolia.instantsearch.showcase.suggestion.suggestion.SuggestionAdapter.SuggestionViewHolder
    ...
    class SuggestionViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: Suggestion, onClick: ((Suggestion) -> Unit)) {
            ...
            view.findViewById<TextView>(R.id.itemName).text =
                item.highlightedQuery?.toSpannedString() ?: item.query
        }
    }
