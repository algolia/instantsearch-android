...
import com.algolia.instantsearch.telemetry.extension.asJsonString
...
public class TelemetryTest {
    ...
    public fun test() {
        ...
        telemetryController.trace(ComponentType.hitsSearcher, listOf(ComponentParam.client, ComponentParam.indexName, ComponentParam.UNRECOGNIZED))
