 ...
 */
const renderDropdownItem = (done, t) => {
  return done += `
  <li>
...
const renderDropdownList = (data) => {
  ...
  Object.keys(data).forEach(list => {
    ...
    <div class="algc-dropdownroot__section">
      ...
      <ul class="algc-dropdownroot__${listItem.style}">`;

    listString += listArray.reduce((prev, next, i) => renderDropdownItem(prev, next), "");
    listString +=
      `</ul>
