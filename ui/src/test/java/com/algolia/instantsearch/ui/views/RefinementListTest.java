...
public class RefinementListTest extends InstantSearchTest {
    ...
    public void setup() {
        ...
        final ActivityController<TestActivity> buildActivity = Robolectric.buildActivity(TestActivity.class);
        final ActivityController<TestActivity> create = buildActivity.create();
        ActivityController<TestActivity> activityController = create.start();
        final TestActivity testActivity = activityController.get();
        mRefinementList = testActivity.getRefinementList();
    }
