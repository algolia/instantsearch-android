...
public class FilterResultsWindow extends PopupWindow {
    ...
    public FilterResultsWindow(Activity activity, Searcher searcher) {
        super(FilterResultsWindow.getInflatedLayout(activity, R.layout.popup_filter), WRAP_CONTENT, WRAP_CONTENT);
    ...
    public FilterResultsWindow setToggleButton(final Button b) {
     ...
     */
    public FilterResultsWindow addSeekBar(final String attribute, final int steps) {
     ...
     * @return the fragment to allow chaining calls.
     */
    public FilterResultsWindow addSeekBar(final String attribute, final String name, final int steps) {
     ...
     * @return the fragment to allow chaining calls.
     */
    public FilterResultsWindow addSeekBar(final String attribute, final Double min, final Double max, final int steps) {
     ...
     * @return the fragment to allow chaining calls.
     */
    public FilterResultsWindow addSeekBar(final String attribute, final String name, final Double min, final Double max, final int steps) {
     ...
     * @return the fragment to allow chaining calls.
     */
    public FilterResultsWindow addCheckBox(final String attribute, boolean checkedIsTrue) {
     ...
     * @return the fragment to allow chaining calls.
     */
    public FilterResultsWindow addCheckBox(final String attribute, final String name, final boolean checkedIsTrue) {
