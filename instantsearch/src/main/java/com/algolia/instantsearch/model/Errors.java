...
public class Errors {
    ...
    public static final String LAYOUT_MISSING_HITS = "You need to add an AlgoliaResultsListener identified as @id/hits.";
    ...
    public static final String REFINEMENTS_RECEIVED_ERROR = "RefinementsList received an error: %s.";
