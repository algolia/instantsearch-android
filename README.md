...
```groovy
implementation 'com.algolia:instantsearch-android:1.15.1'

// OR, if your application uses AndroidX
implementation 'com.algolia:instantsearch-androidx:1.15.1'
...
```groovy
<<<<<<< HEAD
implementation 'com.algolia:instantsearch-android-core:1.15.1'

// OR, if your application uses AndroidX
implementation 'com.algolia:instantsearch-androidx-core:1.15.1'
